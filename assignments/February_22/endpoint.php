...
// Create the payment data for a credit card
  ...
  $creditCard->setCardNumber($_POST['CreditCardNumber']);  
...
if ($response != null) 
{
  ...
  {
	echo "".$_POST['NameOnCard']."!!"." Your payment of $".$_POST['PaymentAmount']. " has been received. \n";  
     echo "AUTH CODE : " . $tresponse->getAuthCode() . "/n";
